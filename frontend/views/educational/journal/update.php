...
<div class="journal-edit">
    ...
    <div class="control-unit">
        <div class="control-label">
            • Выберите статус одной из кнопок расположенных ниже и нажмите на ячейки или столбцы, в которые необходимо установить значение;<br>
            • Сделайте двойной клик, чтобы сбросить икноку статуса с указателя мыши;<br>
            • Если ячейка окрашена серым цветом, значит она заблокирована от изменений;
        </div>
