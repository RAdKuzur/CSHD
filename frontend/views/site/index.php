        ...
        <div class="index-card" id="card-5">
            ...
            <div class="back-card">
                ...
                <div class="flexx">
                    ...
                    echo HtmlBuilder::createGroupButton(ButtonsFormatter::anyOneLink($svg . ' Ошибки заполнения', Yii::$app->frontUrls::ANALITIC_ERRORS_INDEX, ButtonsFormatter::BTN_SUCCESS, '', Yii::$app->rubac->authId()));
                    ?>
                </div>
                <div class="flexx">
                    <?php
