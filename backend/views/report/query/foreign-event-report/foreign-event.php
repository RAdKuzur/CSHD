...
<div class="man-hours-report-form">
    <h1>Отчет по УЧЕТУ ДОСТИЖЕНИЙ в мероприятиях</h1> <?= HtmlBuilder::createTooltipIcon('Отчет генерируется не по мероприятиям РШТ, а по внешним мероприятиям (те, в которых участвуют наши обучающиеся)') ?>
