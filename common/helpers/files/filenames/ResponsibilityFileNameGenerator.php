...
class ResponsibilityFileNameGenerator implements FileNameGeneratorInterface
{
    ...
    private function generateOtherFileName($object, $params)
    {
        ...
        /** @var LocalResponsibilityWork $object */
        $filename =
            'Файл'.($this->getOrdinalFileNumber($object, FilesHelper::TYPE_OTHER) + $params['counter']).
            '_' . $object->id . '_' . $object->peopleStampWork->surname . '_' . Yii::$app->responsibilityType->get($object->responsibility_type);
